...
namespace CompanyEmployees.Utility
{
    public class EmployeeLinks : IEmployeeLinks
    {
        ...
        public LinkResponse TryGenerateLinks(IEnumerable<EmployeeDto> employeesDto, string fields, Guid companyId, HttpContext httpContext)
        {
            ...
            {
                return ReturnEmployeesWithLinks(employeesDto, fields, companyId, httpContext, shapedEmployees);
            }
        ...
        private LinkResponse ReturnEmployeesWithLinks(IEnumerable<EmployeeDto> employeeDto, string fields, Guid companyId, HttpContext httpContext, List<Entity> shapedEmployees)
        {
