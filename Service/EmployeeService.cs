...
namespace Service
{
    internal sealed class EmployeeService : IEmployeeService
    {
        ...
        public async Task<(IEnumerable<Entity> employees, MetaData metaData)> GetEmployeesAsync(Guid companyId, EmployeeParameters employeeParameters, bool trackChanges)
        {
            ...
            var employeesFromDbWithMetaData = await _repository.Employee.GetEmployeesAsync(companyId, employeeParameters, trackChanges);
            ...
            return (employees: shapedData, metaData: employeesFromDbWithMetaData.MetaData);
        ...
        public async Task<EmployeeDto> GetEmployeeAsync(Guid companyId, Guid id, bool trackChanges)
        {
            ...
            var employeeDb = await GetEmployeeForCompanyIfItExists(companyId, id, trackChanges);
        ...
        public async Task UpdateEmployeeForCompanyAsync(Guid companyId, Guid id, EmployeeForUpdateDto employeeForUpdate, bool compTrackChanges, bool empTrackChanges)
        {
            ...
            var employeeEntity = await GetEmployeeForCompanyIfItExists(companyId, id, empTrackChanges);
        ...
        public async Task<(EmployeeForUpdateDto employeeToPatch, Employee employeeEntity)> GetEmployeeForPatchAsync(Guid companyId, Guid id, bool compTrackChanges, bool empTrackChanges)
        {
            ...
            var employeeDb = await GetEmployeeForCompanyIfItExists(companyId, id, empTrackChanges);
        ...
        private async Task<Employee> GetEmployeeForCompanyIfItExists(Guid companyId, Guid id, bool trackChanges)
        {
